...
function TxFormula(aSettings) {
    ...
    //chek formula
    this.chek_formula = function (aJson) {
    ...
    this.display = function () {
        ...
        if (this.displaytype == 0) {
            ...
            div_formule.setAttribute('class', 'div_formule');
            var formula_txt = document.createElement('label');
            formula_txt.innerHTML = 'formule : ';
           
            div_formule.appendChild(formula_txt);
            var formula_value = document.createTextNode(formula);
            div_formule.appendChild(formula_value);
            display_div.appendChild(div_formule);
            ...
            FormulasGrid.addRow('Formula_row', ['formule : ', this.formula]);
            var formule = FormulasGrid.cells('Formula_row', 1);           
            formule.setDisabled(true);
            FormulasGrid.setCellTextStyle('Formula_row',1,"font-size:10px");
